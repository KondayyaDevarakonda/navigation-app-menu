                    ...
                    <ul className={boxClass.join(' ')}>
                        ...
                        <li onClick={toggleSubmenu} className="menu-item sub__menus__arrows" > <Link to="#"> Shop <FiChevronDown /> </Link>
                            <ul className={boxClassSubMenu.join(' ')} > 
                                <li> <NavLink onClick={toggleClass} className='is-active'  to={`/Online`}> Online Shop </NavLink> </li>
                                <li><NavLink onClick={toggleClass} className='is-active' to={`/Offline`}> Offline Shop </NavLink> </li>
                            </ul>
                        </li>
                        <li className="menu-item " ><NavLink onClick={toggleClass} className='is-active' to={`/Contact`}> Contact </NavLink> </li>
                    </ul>
                    </nav>     
                </div>   
            </div>
